...
useEffect(() => {
  const fetchProductData = async () => {
    try {
      ...
      setProduct(response.data); // البيانات الفعلية من الباك اند
    } catch (error) {
  ...
  return (
    <div className="bg-white min-h-screen pb-24" dir="rtl">
      ...
      <div className="max-w-2xl mx-auto px-6">
        {/* Product Image - شلت الديف الملون وخليتها على الأبيض عادي */}
        ...
        <div className="mt-4">
          <div className="flex items-baseline gap-3 mb-2">
             {/* السعر بدون خلفية رمادية وقريب من الاسم */}
          ...
          {/* الكمية تحت السعر والاسم مباشرة */}
      ...
      {/* زر الإضافة - صغير وليس بعرض الشاشة ومفصول عن الكمية */}
